...
class GrokAIServer {
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            if (request.params.name === 'analyze_transaction') {
                if (!args || typeof args.signature !== 'string') {
                    throw new McpError(ErrorCode.InvalidParams, 'Missing required signature parameter');
                }
                ...
                if (!args || typeof args.address !== 'string') {
                    throw new McpError(ErrorCode.InvalidParams, 'Missing required address parameter');
                }
                ...
                if (!args || typeof args.prompt !== 'string') {
                    throw new McpError(ErrorCode.InvalidParams, 'Missing required prompt parameter');
                }
                ...
                if (!args || typeof args.question !== 'string') {
                    throw new McpError(ErrorCode.InvalidParams, 'Missing required question parameter');
                }
    ...
    async handleAnalyzeTransaction(args) {
        try {
            ...
            const systemPrompt = "You are an expert Solana blockchain analyst. " +
    ...
    async handleAnalyzeAddress(args) {
        try {
